...
function UlympicLogo() {
  return (
    <div className="bungkuss flex justify-center items-center">
      <div className="bungkuss2 flex justify-between pb-6">
        ...
        <h1 style={{ fontFamily: "Akbaal, sans-serif" }} className="judullogoulympic text-5xl font-bold">
          <span style={{ borderBottom: "1px solid black" }}>Ulympic</span>
        </h1>
        <p style={{ fontFamily: "SanFran-Regular, sans-serif" }} className="isilogoulympic text-xl text-justify mt-7">
        ...
        <p style={{ fontFamily: "SanFran-Regular, sans-serif" }} className=" isilogoulympic text-xl text-justify mt-6">
