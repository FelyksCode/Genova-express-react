    ...
    <div className="bg-gradient-to-b from-yellow-400 to-orange-400">
      <div className="content flex flex-col items-center py-8 lg:flex-row lg:justify-evenly xl:items-start lg:py-16">
        <div className="unveiling-logo mb-8 px-4 bg-white rounded-2xl lg:mb-0 lg:py-5">
          <img className="w-56 sm:w-72 xl:w-96" src={logo} alt="Unveiling" />
        </div>
        <div className="unveiling-details">
          <h1 className="text-center font-bold text-4xl sm:text-6xl sm:py-5 lg:text-5xl xl:text-7xl">
            Unveiling
          </h1>
          <p className="bg-white rounded-2xl w-[250px] text-sm sm:w-[500px] xl:w-[800px] xl:text-xl mt-5 px-8 pt-5 pb-5 lg:mb-10">
