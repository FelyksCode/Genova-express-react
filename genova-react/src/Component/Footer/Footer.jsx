...
export default function Footer() {
  return (
    ...
    >
      <div className="flex w-full md:flex-row flex-col justify-evenly items-center py-5 gap-10">
        ...
        <div className="md:flex flex-col justify-center self-center hidden">
          <Sparkle>
            <img className="h-48 footer-img " src={Logo} alt="logo" />
          </Sparkle>
        </div>
